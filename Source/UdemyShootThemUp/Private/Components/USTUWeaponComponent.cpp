...
void UUSTUWeaponComponent::OnEmptyClip(AUSTUBaseWeapon* AmmoEmptyWeapon)
{
...
bool UUSTUWeaponComponent::TryToAddAmmo(TSubclassOf<AUSTUBaseWeapon> WeaponType, int32 ClipsAmount)
{
	for (const auto Weapon : Weapons)
	{
